...
All source code is located in the `src/` directory. Do not modify `main.js` or `styles.css` directly as they are generated by the build process.

- JavaScript/TypeScript: `src/*.ts`
- CSS: `src/css/*.css`
